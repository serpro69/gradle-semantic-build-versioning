...
import io.github.serpro69.gradle.versioning.spock.extensions.gradle.ProjectDirProvider
...
class SemanticBuildVersionPluginSpecification extends Specification {
    ...
    def 'invalid bumpComponent fails the build'() {
        ...
        then:
        buildResult.output.contains 'No such property: PRERELEASE for class: io.github.serpro69.gradle.versioning.VersionComponent'
    }
